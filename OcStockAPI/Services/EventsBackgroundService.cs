...
namespace OcStockAPI.Services
{
    public class EventsBackgroundService : BackgroundService
    {
        ...
        private async Task FetchAndSaveInflationDataAsync(IOcStockDbContext dbContext, IAlphaVantageService alphaVantageService, CancellationToken stoppingToken)
        {
            try
            {
        ...
        private async Task FetchAndSaveFederalInterestRateAsync(IOcStockDbContext dbContext, IAlphaVantageService alphaVantageService, CancellationToken stoppingToken)
        {
            try
            {
        ...
        private async Task FetchAndSaveUnemploymentRateAsync(IOcStockDbContext dbContext, IAlphaVantageService alphaVantageService, CancellationToken stoppingToken)
        {
            try
            {
        ...
        private async Task FetchAndSaveCPIAsync(IOcStockDbContext dbContext, IAlphaVantageService alphaVantageService, CancellationToken stoppingToken)
        {
            try
            {
        ...
        private async Task<Event> GetOrCreateEventAsync(IOcStockDbContext dbContext, DateTime date, CancellationToken stoppingToken)
        {
